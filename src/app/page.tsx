                ...
                <div className="p-4">
                  {activeTab === "contexto" && (
                    <div>
                      ...
                      <p className="text-lg mb-4">
                        Por isso, nos juntamos e criamos este site{" "}
                        <strong className="text-blue-600">para conseguir o valor da cirurgia</strong> e
                        de todos os exames que Mateus precisará!
                      </p>

                      <p className="text-lg mb-4">
                        Seu pai, Darlem, sempre trabalhou com cerâmica, mas hoje
                        está <span className="font-bold">desempregado</span>. A mãe não trabalha para cuidar do{" "}
                        <strong className="text-red-600">Mateus que tem crises fortes de dor</strong>.
                      </p>

                      <p className="text-lg mb-4">
                        Vivem somente com o benefício de um salário mínimo do
                        filho.
                      </p>
                      ...
                      <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-md mb-4">
                        ...
                        <p className="text-md">
                          A vaquinha é para a cirurgia no particular <span className="text-red-600 font-bold">O QUANTO ANTES!</span> Ele nem frequenta a escola de tanta dor!{" "}
                          <strong className="text-blue-600 text-lg">
                            Mateus tem apenas 9 anos e uma vida linda pra viver
                          </strong>.
                        </p>
                      </div>
                      ...
                      <ul className="list-none space-y-3 mb-4 ml-4">
                        <li className="flex items-center">
                          ...
                          <span className="font-bold">Cirurgia Particular de Correção da Coluna</span>
                        </li>
                        <li className="flex items-center">
                          <span className="bg-green-100 text-green-800 font-bold rounded-full w-6 h-6 flex items-center justify-center mr-2">2</span>
                          <span className="font-bold">Transporte para Consultas e Tratamentos</span>
                        </li>
                        <li className="flex items-center">
                          <span className="bg-green-100 text-green-800 font-bold rounded-full w-6 h-6 flex items-center justify-center mr-2">3</span>
                          <span className="font-bold">Melhorias Urgentes na Casa da Família</span>
                        </li>
                      </ul>

                      <div className="bg-gray-50 border-l-4 border-gray-300 p-4 rounded-md mb-6">
                        <p className="text-gray-700 italic">
                          "Cada dia que passa sem a cirurgia, a escoliose avança. Não podemos mais esperar pelo SUS. <span className="font-bold">Cada doação é um passo para salvar o Mateus.</span>"
                        </p>
                      </div>
          ...
          <div className="lg:col-span-4 sticky top-4 self-start">
            ...
            <Card className="p-6 mt-4">
              ...
              <div className="bg-blue-50 p-3 rounded-md mb-4 text-center">
                <p className="text-blue-700 font-medium">Junte-se a essas pessoas generosas que já ajudaram o Mateus!</p>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-center text-sm font-bold text-red-600">Apenas {campaignData.daysRemaining} dias para atingir a meta!</p>
                <button
